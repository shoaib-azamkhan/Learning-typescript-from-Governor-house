...
let numbres:number[] = [10,20,30,40];
...
// Question 5: Add the element "grape" to the end of the fruits array using the
// method.
...
// Question 8: Add the element "kiwi" to the beginning of the fruits array
// using the method.

fruits.unshift("kiwi");

// Question 9: Remove 2 elements from the fruits array starting from index 1
// using the method.
